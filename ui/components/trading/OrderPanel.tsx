...
function DetailRow({ label, value, pencil }: { label: string; value: string; pencil?: boolean }) {
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
      ...
      <span style={{ fontSize: "var(--text-xs)", color: "var(--t2)", fontFamily: "JetBrains Mono, monospace", display: "flex", alignItems: "center", gap: 3 }}>
        {pencil && (
...
export function OrderPanel() {
  ...
  const accentHov  = isLong ? "var(--long-hover)"  : "var(--short-hover)";
            ...
            <div style={{ display: "flex", alignItems: "center", padding: "0 10px 8px", gap: 6 }}>
              <input
                ...
                style={{
                  ...
                  fontSize: 16, fontWeight: 500, fontFamily: "JetBrains Mono, monospace", letterSpacing: "-0.02em",
                  color: limitPrice ? "var(--t1)" : "var(--t3)",
                }}
              />
              <span style={{ fontSize: "var(--text-xs)", color: "var(--t3)", fontFamily: "JetBrains Mono, monospace", flexShrink: 0 }}>USD</span>
            </div>
          </div>
        </div>
      )}
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 10px 8px" }}>
            <input
              ...
              style={{
                ...
                width: "55%", fontFamily: "JetBrains Mono, monospace",
              }}
            />
            ...
            <div style={{ flex: 1, borderRadius: "var(--radius-md)", border: "1px solid var(--long-mid)", background: "var(--long-dim)", padding: "6px 10px" }}>
              ...
              <input
                ...
                style={{
                  ...
                  fontSize: "var(--text-sm)", fontFamily: "JetBrains Mono, monospace", fontWeight: 500,
                  color: "var(--long)",
                }}
              />
            </div>
